class LearnerAssignOrEnrol:
    def __init__(
        ...
        class_id="",
        course_id="",
        is_enrolment_approved="",
        is_completed="",
        is_enrolment_rejected="",
    ):
        ...
        self._is_enrolment_rejected = is_enrolment_rejected
    ...
    def get_is_enrolment_rejected(self):
        return self._is_enrolment_rejected
