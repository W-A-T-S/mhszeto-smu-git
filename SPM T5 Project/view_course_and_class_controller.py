...
def courses():
    ...
    return render_template("adminViewCourses.html", introText = courseText, courses = courses_dict)
...
def classes(courseid):
    ...
    for eachClass in classes:
        ...
        #learners is a list
        learners_assignment_list = learnerAssignOrEnrolDAO.find_query(query=queryLearners)
        ...
        for aLearner_assignment in learners_assignment_list:
            ...
            learner_details = learnerDAO.find_one(aLearner_assignment.get_learner_username())
